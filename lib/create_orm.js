...
function initOrm() {
  ...
  orm.Job = yizhaopin.define('job', {
    ...
    Description: {type: Sequelize.STRING(2000), allowNull: false},//详细描述
  ...
  orm.Resume = yizhaopin.define('resume', {
    ...
    WorkExperience: {type: Sequelize.STRING(65535), allowNull: false},//工作经历JSONString[{company:"",position:"",joinTime:"",leaveTime:"",content:""},...]
    EducationExperience: {type: Sequelize.STRING(5000), allowNull: false},//教育经历:JSONString[{school:"",major:"",endTime:"",degree:""}]
    ExpectWork: {type: Sequelize.STRING(65535), allowNull: false},//期待工作JSONString:{name:"前端",type:"全职",city:"南京",salary:1,addtion:"补充说明(若有)"}
    ProjectExperience: {type: Sequelize.STRING(65535), allowNull: true}, //项目经验 JSONString {name:"商城",position:"",startTime:"",endTime:"",description:"",link:""}
    PersonalDescription: Sequelize.STRING(3200),//个人描述
    Delete: {type: Sequelize.INTEGER(1), allowNull: false, defaultValue: 1},//删除字段:{-1:删除，>=1未删除}
  });
  /**
   * 简历投递表
